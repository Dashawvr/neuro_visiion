...
import {
    PersonalDashboard, Stage, Roles, Users, EditPanel, CrmDashboard, CryptoDashboard,
...
////////////////////////////////
    useInterval(() => {
        ...
        const lightThemeHours = hours => hours >= 4 && hours < 18;
    ...
    return (
        <Dashboard history={history} changeMode={changeMode}>
            <Switch>
                ...
                <Route path={"/maps"} component={StreetViewMap}/>
        ...
        //   {/*  <Route  path="/dashboards" component={DashboardNew} />*/}
