...
import CreateWidgetLink from '../Form/Create/CreateWidgetLink';
...
class CreateWidgetLinkForm extends React.Component {
  state = {
    variant: '',
    message: '',
    open: false,
...
export default withStyles(styles)(withRouter(withTranslation()(CreateWidgetLinkForm)));