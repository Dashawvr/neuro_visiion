...
import EditWidgetImage from '../Form/Edit/EditWidgetImage';
...
class EditWidgetImageForm extends React.Component {
  state = {
    variant: '',
    message: '',
    open: false,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock title={t('EditWidgetImage.title')} icon="ios-list-box-outline" desc="">
          <div>
            <EditWidgetImage
...
export default withStyles(styles)(withTranslation()(EditWidgetImageForm));
