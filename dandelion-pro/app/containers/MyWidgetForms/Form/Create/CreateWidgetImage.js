...
class CreateWidgetImage extends Component {
  render() {
    const {
      classes,
      handleSubmit,
        ...
        <Grid container spacing={3} alignItems="flex-start" direction="row" justify="center">
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="subtitle2" gutterBottom>
                {t("ignore-x-frame.image")} <br/> {t("ignore-x-frame.main")}
              ...
              <div>
                ...
                <div>
                  <Field
                    name="data"
                    component={TextFieldRedux}
                    placeholder={t('AddWidgetImage.text')}
                    label={t('AddWidgetImage.text')}
                    validate={required}
                    required
                    ref={this.saveRef}
                    className={classes.field}
