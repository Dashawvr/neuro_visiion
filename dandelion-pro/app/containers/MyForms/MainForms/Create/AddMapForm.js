...
import AddMap from '../../Forms/Create/AddMap';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock title={t('AddMap.title')} icon="ios-list-box-outline" desc="">
          <div>
...
export default withStyles(styles)(withTranslation()(AddMapForm));
