...
import EditCamera from '../../Forms/Edit/EditCamera';
...
class EditCameraForm extends React.Component {
  state = {
    variant: '',
    message: '',
    open: false,
  ...
  render() {
    ...
    const { message, variant, open, camera } = this.state;
    const { t } = this.props;
...
export default withStyles(styles)(withTranslation()(EditCameraForm));
