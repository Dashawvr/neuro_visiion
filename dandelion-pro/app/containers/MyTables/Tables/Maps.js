        ...
        <Fragment>
            ...
            />
                ...
                <div>
                    <br />
                    <br />
                    <Button onClick={() => this.props.history.push(`/home/forms/add/maps`)} className={classes.button} variant="contained" color="primary">
                        {t('Buttons.create')}
                        <AddCircleOutlineIcon className={classes.rightIcon} />
                    </Button>
                    <Button onClick={() => this.props.history.push(`/home/forms/edit/maps?id=${id}`)} className={classes.button} variant="contained" color="secondary">
                        {t('Buttons.edit')}
...
export default withStyles(styles)(withRouter(withTranslation()(Maps)));
