...
class Roles extends React.Component {
  ...
  render() {
    ...
    const handleDelete = (id) => {
      if (id) {
        request(`${URL}/api/role/${id}`, paramsDelete);
      } else {
    ...
    const handleEdit = (id) => {
      if (id) {
        history.push('/app/forms/edit/role/?id=' + id);
      } else {
    ...
    return (
      <Fragment>
        ...
        <div>
          <br />
          <br />
          <Button onClick={() => history.push('/app/forms/add/role')} className={classes.button} variant="contained" color="primary">
            Create
